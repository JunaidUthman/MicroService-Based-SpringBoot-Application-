...
public class CustomerConfig {
    ...
    //RestTemplate is a synchronous(for asynchronous,use kafka or rabbitMQ) client-side object provided by Spring that is used for consuming RESTful web services.
